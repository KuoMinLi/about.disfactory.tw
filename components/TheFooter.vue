<template>
  <footer>
    ...
    <div class="containr">
      ...
      <p>
        Email:
        <a href="https://github.com/Disfactory" target="_blank" rel="noopener"
          >cet@cet-taiwan.org</a
        >
      </p>
      <p>電話：02-23920371</p>
      <p>
    ...
    <p class="license">
      全站由使用者回報之資料及設計圖以CC
      BY姓名標示4.0釋出，標註「農地違章工廠回報系統貢獻者」，原始碼已MIT開放授權公開在<a
        href="https://github.com/Disfactory"
        target="_blank"
        rel="noopener"
        >GitHub</a
          ...
          <div class="modal-content">
            ...
            <div class="introduction">
              ...
              <div>
                ...
                <p>
                  Don't ask why nobody is doing this. <br />Become that nobody.
                </p>
              </div>
            </div>
            ...
            <div class="list">
              ...
              <div class="group">
                ...
                <div class="group-member">
                  <p>chewei、ronnywang、bdon、pm5、kiang、shupo</p>
                </div>
              </div>
              <div class="group">
                <div class="group-name">PM</div>
                <div class="group-member">
                  <p>ael</p>
                </div>
              </div>
              ...
              <div class="group">
                ...
                <div class="group-member">
                  <p>
                    ...
                    Huang、zyan、tai、slayer、mg、robin、星穎、ichieh、isabel、Tiff、雅安、Jay Lo、mcdlee、CRW、Guo-Jim
                  </p>
                </div>
              </div>
            </div>
